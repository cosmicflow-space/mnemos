...
const EXT_TO_CLASSIFICATION: Record<string, Classification> = {
  ...
  ".jpg": { kind: "image", category: "deferred", label: "images", note: "OCR support coming in v0.2" },
  ".jpeg": { kind: "image", category: "deferred", label: "images", note: "OCR support coming in v0.2" },
  ".png": { kind: "image", category: "deferred", label: "images", note: "OCR support coming in v0.2" },
  ".gif": { kind: "image", category: "deferred", label: "images", note: "OCR support coming in v0.2" },
  ".webp": { kind: "image", category: "deferred", label: "images", note: "OCR support coming in v0.2" },
  ".heic": { kind: "image", category: "deferred", label: "images", note: "OCR support coming in v0.2" },
  ".tiff": { kind: "image", category: "deferred", label: "images", note: "OCR support coming in v0.2" },
